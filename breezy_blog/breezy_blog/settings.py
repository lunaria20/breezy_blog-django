...
# Development mode
DEBUG = True   # 👈 keep this True while developing
...
# --- Auth redirects ---
LOGIN_URL = "login"               # 👈 Fix: now it uses your /login/ URL
LOGIN_REDIRECT_URL = "home"       # After login → homepage
LOGOUT_REDIRECT_URL = "register"  # After logout → register page
